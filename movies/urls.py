...
urlpatterns = [
    path("", views.MoviesView.as_view(), name='catalog'),
    path("filter/", views.FilterMoviesView.as_view(), name='filter'),
    path("add-rating/", views.AddStarRating.as_view(), name='add_rating'),
    path("search/", views.SearchMoviesView.as_view(), name='search_results'),
    path("index/", views.MoviesView.as_view(), name='index'),
